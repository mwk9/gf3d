...
void gf3d_mesh_init(Uint32 mesh_max)
{
	...
	gf3d_mesh.attributeDescriptions[2].offset = offsetof(Time, time);*/
...
void gf3d_mesh_render(Uint32 entityID, Uint32 swapchainImageID, Mesh *mesh, VkCommandBuffer commandBuffer, VkDescriptorSet * descriptorSet)
{
    ...
    vkCmdBindDescriptorSets(commandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, pipe->pipelineLayout, 0, 1, descriptorSet, 1, &dynamicOffsets);
